              ...
              <div class="logos mb-4" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="logos-images d-flex gap-4 align-items-center">
                  <img
                    ...
                    src="<?php echo get_template_directory_uri(); ?>/src/assets/images/logo/actual-size/logo-air-bnb__black.svg"
                    alt="Company 1"
                    style="width: 110px;">
                  <img
                    class="img-fluid js-img-to-inline-svg"
                    src="<?php echo get_template_directory_uri(); ?>/src/assets/images/logo/actual-size/logo-ibm__black.svg"
                    alt="Company 2" style="width: 80px;">
                  <img
                    class="img-fluid js-img-to-inline-svg"
                    src="<?php echo get_template_directory_uri(); ?>/src/assets/images/logo/actual-size/logo-google__black.svg"
                    alt="Company 3" style="width: 110px;">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6">
          <div class="hero-img">
            <img
              ...
              src="<?php echo get_template_directory_uri(); ?>/src/assets/images/card-expenses.png"
              alt="Image card"
              data-aos="fade-down"
              data-aos-delay="600">
            <img
              class="img-main img-fluid rounded-4"
              src="<?php echo get_template_directory_uri(); ?>/src/assets/images/hero-img-1-min.jpg"
              alt="Hero Image"
              data-aos="fade-in"
              data-aos-delay="500">
          </div>
        ...
        <div class="col-md-6">
          <div class="img-wrap position-relative">
            <img
              ...
              src="<?php echo get_template_directory_uri(); ?>/src/assets/images/about_2-min.jpg"
          ...
          <div class="row">
            ...
            ?>
              <div class="col-12 mb-3">
                <?php get_template_part( 'src/template-parts/content', 'featured' ); ?>
              </div>
            <?php
                endwhile;
                wp_reset_postdata();
            ...
            ?>
              <div class="col-sm-6">
                <?php get_template_part( 'src/template-parts/content', 'secondary' ); ?>
              </div>
            <?php
                endwhile;
                wp_reset_postdata();
      ...
      <div class="row g-md-5">
        <div class="col-md-6 col-lg-3">
          <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative" data-aos="fade-up" data-aos-delay="0">
            <div data-aos="fade-right" data-aos-delay="500"><img class="arch-line" src="<?php echo get_template_directory_uri(); ?>/src/assets/images/arch-line.svg" alt="FreeBootstrap.net image placeholder"></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">1</span>
            <div>
        ...
        <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="600">
          <div class="step-card reverse text-center h-100 d-flex flex-column justify-content-start position-relative">
            <div data-aos="fade-right" data-aos-delay="1100"><img class="arch-line reverse" src="<?php echo get_template_directory_uri(); ?>/src/assets/images/arch-line-reverse.svg" alt="FreeBootstrap.net image placeholder"></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">2</span>
        ...
        <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="1200">
          <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative">
            <div data-aos="fade-right" data-aos-delay="1700"><img class="arch-line" src="<?php echo get_template_directory_uri(); ?>/src/assets/images/arch-line.svg" alt="FreeBootstrap.net image placeholder"></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">3</span>
      ...
      <div class="row g-4" data-masonry="{&quot;percentPosition&quot;: true }">
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
          <div class="testimonial rounded-4 p-4">
            ...
            <div class="testimonial-author d-flex gap-3 align-items-center">
              <div class="author-img"><img class="rounded-circle img-fluid" src="<?php echo get_template_directory_uri(); ?>/src/assets/images/person-sq-2-min.jpg" alt="FreeBootstrap.net image placeholder"></div>
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
          <div class="testimonial rounded-4 p-4">
            ...
            <div class="testimonial-author d-flex gap-3 align-items-center">
              <div class="author-img"><img class="rounded-circle img-fluid" src="<?php echo get_template_directory_uri(); ?>/src/assets/images/person-sq-1-min.jpg" alt="FreeBootstrap.net image placeholder"></div>
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
          <div class="testimonial rounded-4 p-4">
            ...
            <div class="testimonial-author d-flex gap-3 align-items-center">
              <div class="author-img"><img class="rounded-circle img-fluid" src="<?php echo get_template_directory_uri(); ?>/src/assets/images/person-sq-5-min.jpg" alt="FreeBootstrap.net image placeholder"></div>
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
          <div class="testimonial rounded-4 p-4">
            ...
            <div class="testimonial-author d-flex gap-3 align-items-center">
              <div class="author-img"><img class="rounded-circle img-fluid" src="<?php echo get_template_directory_uri(); ?>/src/assets/images/person-sq-3-min.jpg" alt="FreeBootstrap.net image placeholder"></div>
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
          <div class="testimonial rounded-4 p-4">
            ...
            <div class="testimonial-author d-flex gap-3 align-items-center">
              <div class="author-img"><img class="rounded-circle img-fluid" src="<?php echo get_template_directory_uri(); ?>/src/assets/images/person-sq-7-min.jpg" alt="FreeBootstrap.net image placeholder"></div>
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
          <div class="testimonial rounded-4 p-4">
            ...
            <div class="testimonial-author d-flex gap-3 align-items-center">
              <div class="author-img"><img class="rounded-circle img-fluid" src="<?php echo get_template_directory_uri(); ?>/src/assets/images/person-sq-8-min.jpg" alt="FreeBootstrap.net image placeholder"></div>
